        ...
        function updStatusAll() {
            ...
            if (flag) {
                if (confirm("你确认要一键通过这" + j + "项？")) {
                    $.ajax({
                        url: "${rootUrl}company/solution/audit/updStatusAll",
                        type: "POST",
                        data: {ids: ids},
                        dataType: "text",
        ...
        <div class="mainRight">
            ...
            <div class="main-right-con">
                <form:form modelAttribute="pageModel" id="listForm" name="listForm"
                           action="${rootUrl }company/solution/audit/manage" method="get">
                    <input type="hidden" id="pageNo" name="pageNo" value="1">
                </form:form>
                <div class="main-right-form">
                    <ul class="main-right-form-ul">
                        <li <c:if test="${type==1}">class="active"</c:if>><a href="manage?type=1">总体解决方案</a></li>
                        <li <c:if test="${type==2}">class="active"</c:if>><a href="manage?type=2">专项解决方案</a></li>
                    </ul>
