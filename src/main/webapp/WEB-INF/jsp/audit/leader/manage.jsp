...
function updStatusAll() {
	...
	if (flag) {
		if (confirm("你确认要一键通过这"+j+"项？")) {
	     $.ajax({
	         url: "${rootUrl}company/leader/audit/updStatusAll",
	         type: "POST",
	         data: {ids:ids},
	         dataType: "text",
        ...
        <div class="Main">
            <div class="mainRight">
                ...
                <div class="main-right-con">
                	<form:form modelAttribute="pageModel" id="listForm" name="listForm" action="${rootUrl }company/leader/audit/manage" method="get">	
