	...
	$(function(){
		$.ajax({  
	        ...
	        success : function(data) {  
	        	alert(data);
	        	window.location.href = "${rootUrl }company/culture/audit/manage";
	        },  
	        error : function(data) { 
	        	alert("网络连接失败，请联系管理员");
	        }  
	...
	<div class="container">
        <div class="Main">
                ...
                <div class="main-right-con">
                    <form:form modelAttribute="pageModel" id="addForm"  method="post">
					...
					<div class="main-footer-btn">
						<a class="edit-a" data-href="${rootUrl }company/culture/audit/updStatus/${pageModel.id}?status=1" onClick="javascript:updStatus(this)">通过</a>
						<a class="add-a" data-href="${rootUrl }company/culture/audit/updStatus/${pageModel.id}?status=2" onClick="javascript:updStatus(this)">不通过</a>
                    </div>
                </div>
            </div>
        </div>
