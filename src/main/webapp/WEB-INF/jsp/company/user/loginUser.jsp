	                  ...
	                  <div class="main-right-table-con">
	                  		<table class="culture-table-add">
								...
								<tr>
									...
									<td><input class="inputxt" type="password" maxlength="100" type="text" name="passwdR"
											   value="${editUserInfo.passwd}" placeholder="必填" onkeyup="validate()"></td>
								</tr>
	                          	<tr>
		                            ...
		                            <td>
	                          		...
	                          		<td>
										<input hidden name="roleId" value="${editUserInfo.role.id}">
	                          			<select class="selectxt" id="addUser_role" disabled>
