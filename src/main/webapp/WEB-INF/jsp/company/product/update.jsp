	...
	<div class="container">
        <div class="Main">
                ...
                <div class="main-right-con">
                    <form:form modelAttribute="pageModel" id="addForm" action="${rootUrl}company/product/update" enctype="multipart/form-data" method="post">
	                    <form:hidden path="id" />
	                    ...
	                    <div class="main-right-table-con">
							<table class="culture-table-add">
	                          ...
	                          <tr>
	                            ...
	                            <td colspan="3"><form:input maxlength="64" type="text" class="inputxt" path="name"/></td>
	                          </tr>
	                          <tr>
                                ...
                                <td>
                                    <select class="selectxt" name="type">
                                        <c:forEach items="${types }" var="vo">
                                             <option value="${vo.key}" <c:if test="${vo.key ==pageModel.type }">selected="selected"</c:if>>${vo.value}</option>
                                        </c:forEach>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select class="selectxt" name="subType">
                                        <c:forEach items="${subTypes }" var="vo">
                                             <option value="${vo}" <c:if test="${vo ==pageModel.subType }">selected="selected"</c:if>>${vo.value}</option>
                                        </c:forEach>
                                    </select>
                                </td>
                             </tr>
